...
## 🔑 المفاتيح الجاهزة للدخول

### مفاتيح تعمل الآن (مع النسخة الأصلية):

| ادخل هذا في التطبيق | المدة | الأجهزة |
|---------------------|-------|---------|
| `ali2026` | 274 سنة (غير محدود) | 999 |
| `test` | 274 سنة | 999 |
| `vip` | 274 سنة | 999 |
| `admin` | 274 سنة | 999 |
| `1234` | 274 سنة | 999 |
...
**النسخة المعدّلة (Shadow VIP):**
- اكتب **أي كلمة** → اضغط Login → يدخل مباشرة

**النسخة الأصلية (Zero_LoaderV4.4.01.apk):**
- اكتب أحد المفاتيح أعلاه (مثل `ali2026`) → اضغط Login → يدخل
...
python3 create_key.py
```
غيّر `USERNAME` في أول السكربت لأي اسم تريده.
