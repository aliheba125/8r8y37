...
.method private static capture()Ljava/lang/String;
    .locals 6
...
.method private static saveToDownloads(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    .locals 5
    ...
    invoke-static {p0, p1}, Lcom/tcore/utils/DiagDl29;->save(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v2, "pubg_login_diag.txt"
...
.method public static exportFromHost(Landroid/content/Context;)V
    ...
    const-string v0, "PUBGDIAG: preparing export..."
    ...
    invoke-static {}, Lcom/tcore/utils/DiagLog;->capture()Ljava/lang/String;
    ...
    invoke-static {p0, v0}, Lcom/tcore/utils/DiagLog;->saveToDownloads(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_nopath
    const-string v4, "no file (sharing as text)"
    ...
    invoke-static {p0, v3}, Lcom/tcore/utils/DiagLog;->toast(Landroid/content/Context;Ljava/lang/String;)V

    if-lez v1, :cond_done

    sget-boolean v1, Lcom/tcore/utils/DiagLog;->shared:Z

    if-nez v1, :cond_done

    const/4 v1, 0x1

    sput-boolean v1, Lcom/tcore/utils/DiagLog;->shared:Z
    ...
    const-string v3, "PUBG login diagnostic"
    ...
    const-string v0, "Send PUBGDIAG log"
    ...
    const-string v2, "PUBGDIAG export error: "
