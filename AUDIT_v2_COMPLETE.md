...
هذا الـ bug موجود من الأصل — الملف `224e340326ab180227221ddf4d8b36be` لديه نفس الحالة.
...
11. **الأولوية:** P1 (يحتاج rebuild من source)
...
5. **إذا أردت تحديث حقيقي:** تحتاج rebuild لـ sock/bypass daemons من source
